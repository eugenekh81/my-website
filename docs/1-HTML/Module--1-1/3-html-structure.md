...
<Image src='/img/HTML/Module--1-1/dom-tree.png' />
...
Раніше в HTML були версії, остання - це **HTML5**. Зараз **[HTML Living Standard](https://html.spec.whatwg.org/multipage/)** - це єдина специфікація мови HTML, в якій відмовилися від версій, вона просто оновлюється. Якщо говорять про HTML5, то це те саме, що «сучасний HTML» або HTML Living Standard, тільки коротше.

:::

## Елементи верхнього рівн
...
<Image src='/img/HTML/Module--1-1/block-elements.png' />
...
<Image src='/img/HTML/Module--1-1/inline-elements.png' />
