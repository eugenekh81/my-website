...
В редакторі VSCode, в HTML-документі можна набрати код <code>lorem10</code>, після чого натиснути клавішу Tab. Це створить масив тексту з 10 слів. Замість 10 можна поставити будь-яке число.
...
<CodePenSnippet src="https://codepen.io/goit-academy/embed/mdVZepj?height=265&amp;theme-id=default&amp;default-tab=result" />
...
За специфікацією в теги <code>&lt;ul&gt;</code> і <code>&lt;ol&gt;</code> можна вкладати тільки елементи списку - теги <code>&lt;li&gt;</code>. Водночас, всередині тегів <code>&lt;li&gt;</code> можуть бути вкладені інші довільні теги.
:::
...
<CodePenSnippet src="https://codepen.io/goit-academy/embed/WNrqQzV?height=265&theme-id=default&default-tab=result" />
...
:::caution[ВАЖЛИВО]
Важливо не плутати посилання і кнопку. Якщо по кліку на елемент інтерфейсу відбувається перехід за якоюсь адресою, тобто присутній <code>href</code>, то це посилання. Якщо ж по кліку відбувається щось без перезавантаження або перенаправлення сторінки - це гарантовано кнопка.
:::
