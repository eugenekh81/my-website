...
<img src='/img/HTML/Module--1-1/algorithm.jpeg' />

## Розмітка сторінки

Використовуючи всі розглянуті теги, створимо розмітку простої сторінки починаючої веб-студії.

<CodePenSnippet src="https://codepen.io/goit-academy/embed/ExPmoKE?height=265&amp;theme-id=default&amp;default-tab=html,result" />
