...
<Image src='/img/HTML/Module--1-1/alt-1.jpg' />
...
:::tip[ЦІКАВО]
Наприклад, по кліку на [посилання з такою адресою](https://images.pexels.com/photos/583842/pexels-photo-583842.jpeg), в браузері відкриється вкладка із зображенням, яке лежить десь на сервері в інтернеті.
:::
...
<Image src='/img/HTML/Module--1-1/project-structure.png' />
...
<Image src="/img/HTML/Module--1-1/image-formats.jpg"/>

**`Векторна графіка`** буде відображатися однаково добре на звичайних екранах і на екранах з високою піксельною щільністю.
**`Растрова графіка`**, особливо стиснута з втратою якості, буде виглядати розмито.
...
<Image src='/img/HTML/Module--1-1/baseline-jpg.jpg' />
...
<Image src='/img/HTML/Module--1-1/progressive-jpg.jpg' />
...
Для того щоб зробити прогресивне JPEG-зображення, достатньо скористатися спеціальними інструментами, зокрема онлайн. Наприклад, у разі оптимізації JPEG-зображень в [Squoosh](https://squoosh.app/), вони за замовчуванням (_автоматично_) перетворюються у прогресивні.
