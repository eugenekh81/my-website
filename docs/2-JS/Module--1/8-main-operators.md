...
<img src='/img/JS/Module--1/not-strict-equality.png' alt='Таблиця порівняння значень з використанням операторів нестрогої рівності' />
...
<img src='/img/JS/Module--1/strict-equality.png' alt='Таблиця порівняння значень з використанням операторів строгої рівності' />
