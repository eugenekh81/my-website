...
<Image src='/img/JS/original.svg' alt='Оригінал документу'/>
...
<Image src='/img/JS/by-value.svg' alt='Копії документа'/>
...
<Image src='/img/JS/by-reference.svg' alt='Доступ за посиланням'/>
...
<Image src='/img/JS/full.svg' alt='Порівняння доступу за значенням та доступу за посиланням' />
